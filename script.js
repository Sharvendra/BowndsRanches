// $('#page2').textillate({ in: { effect: 'fadeInDown' } });
function init() {
...
document.querySelector("#page3").addEventListener("mousemove",function(dets){
  document.querySelector("#page3 #text-move").style.left = `${dets.x}px`
  document.querySelector("#page3 #text-move").style.top = `${dets.y}px`
})
